...
const CertificationLogos = () => {
  ...
  return (
    <div className="mx-auto px-18 py-8">
      ...
      <div className="flex flex-wrap justify-center items-center gap-8">
        {certifications.map((logo, index) => (
          <div
            key={index}
            className="flex items-center justify-center w-48 h-48 p-0 rounded-full bg-white  shadow-md hover:shadow-xl transition-shadow duration-300"
          >
            <img
              src={logo}
