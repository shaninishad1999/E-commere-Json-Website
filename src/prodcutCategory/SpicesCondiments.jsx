...
const SpicesCondiments = () => {
  ...
  useEffect(() => {
    fetch("https://e-commerce-json-data-ommh.onrender.com/products/?category=SpicesCondiments")
      .then((res) => res.json())
  ...
  return (
    <Container className="py-5">
      <h2 className="text-center text-success mb-4">Our Organic Spices & Condiments</h2>
      <Row className="g-4">
