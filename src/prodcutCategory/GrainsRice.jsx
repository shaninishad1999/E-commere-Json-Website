...
const GrainsRice = () => {
  ...
  useEffect(() => {
    fetch("https://e-commerce-json-data-ommh.onrender.com/products/?category=GrainsRice")
      .then((res) => res.json())
  ...
  return (
    <Container className="py-5">
      <h2 className="text-center text-success mb-4">Our Organic Grains & Rice</h2>
      <Row className="g-4">
